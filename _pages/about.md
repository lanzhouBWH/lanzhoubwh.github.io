...
[Download Academic CV (PDF)](/files/CV.pdf)
[Download Industry CV (PDF)](/files/Zhou_Lan_Industry_CV_5_3_2026.pdf)
...
- <span style="background:#4C78A8;color:white;padding:2px 6px;border-radius:4px;">Neuroscience</span>  
  Lan Z, Foster S, Charney M et al.  
...
- <span style="background:#4C78A8;color:white;padding:2px 6px;border-radius:4px;">Neuroscience</span>  
  Beroukhim B et al.  
  **A novel automated pipeline to assess MR spectroscopy quality control.**  
  *Journal of Neuroimaging*, 35(1), 2025.
...
- <span style="background:#E45756;color:white;padding:2px 6px;border-radius:4px;">Cardiology</span>  
  McGonagle B et al.  
  **Association Between Active Cancer and Risk of Thrombotic and Cardiovascular Outcomes in Outpatients with COVID-19.**  
  *TH Open*, 2025.

- <span style="background:#E45756;color:white;padding:2px 6px;border-radius:4px;">Cardiology</span>  
  Bikdeli B et al.  
  **Adjudicated Cardiovascular Events in Patients With COVID‐19.**  
...
- <span style="background:#E45756;color:white;padding:2px 6px;border-radius:4px;">Cardiology</span>  
  Leyva H et al.  
  **Non-O Blood Groups and Cardiovascular Outcomes in COVID-19.**  
...
- <span style="background:#E45756;color:white;padding:2px 6px;border-radius:4px;">Cardiology</span>  
  Bikdeli B et al.  
  **Major Cardiovascular Events After COVID-19: CORONA-VTE-Network Study.**  
...
- <span style="background:#E45756;color:white;padding:2px 6px;border-radius:4px;">Cardiology</span>  
  ...
  *New England Journal of Medicine*, 393(12):1166–1176, 2025.
...
- <span style="background:#F58518;color:white;padding:2px 6px;border-radius:4px;">Software</span>  
  Lan Z, Zhao Y, Kang J, Yu T.  
  **Bayesian Network Feature Finder (BANFF): an R Package for Gene Network Feature Selection.**  
  *Bioinformatics*, 32(23):3685–3687, 2016.