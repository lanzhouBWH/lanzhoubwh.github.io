...
-   [Neuroscience]{style="background:#4C78A8;color:white;padding:2px 6px;border-radius:4px;"}\
...
-   [Endocrinology]{style="background:#F58518;color:white;padding:2px 6px;border-radius:4px;"}\
